	...
	return (
		<section className="page justify-center items-center">
			<div className="w-full max-w-2xl">
				<h1 className="font-black text-center text-3xl md:text-4xl mb-4">Register</h1>
				<p className="text-center font-medium text-lg text-gray-700 mb-6">Create a new account here</p>
				<form action={formAction} className="flex flex-col gap-3">
					<InputField name="name" label="Name:" placeholder="Enter your name" defaultValue={state.form?.name} error={state.errors?.name} ref={inputRefs} />
				...
				<p className="mt-3 text-center">
					...
					<Link className="font-medium underline hover:text-emerald-500" href="/login">
						Login
					</Link>
				</p>
			</div>
